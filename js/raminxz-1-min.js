(function(w, i) {
        ...
        if (b && b.indexOf(",") >= 0)
            ...
            if (d)
                if (b === i)
                    ...
                    if (e && e.length > 0) {
                        c === i ? (za(a, b, e[0]),
                        delete v[d][b]) : (m(e, function(a, b) {
                            a > 0 && b === c && e.splice(a, 1)
                        }),
                        e.length == 1 && (za(a, b, e[0]),
                        delete v[d][b]));
                        var g = 0;
                        m(v[d], function() {
                            g++
    ...
    function Ka(a, b, c) {
        ...
        aa(a, "keydown", function(d) {
            d.ctrlKey && d.which == b && !d.shiftKey && !d.altKey && (c.call(a),
            d.stop())
        })
    }
    function ba(a) {
    ...
    function U(a, b, c, d, e) {
        ...
        h.script || (a = a.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/ig, "")),
        h.style || (a = a.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/ig, "")));
        var f = []
                ...
                if (l === "font") {
                    ...
                    m(z, function(a, b) {
                        if (a === "color")
                            L.color = b,
                            delete z[a];
                        a === "size" && (L["font-size"] = g[parseInt(b, 10) - 1] || "",
                        delete z[a]);
                        a === "face" && (L["font-family"] = b,
                        delete z[a]);
                        a === "style" && (F = b)
                    });
                    F && !/;$/.test(F) && (F += ";");
    ...
    function Xb(a, b) {
        var c = W(a)
          , d = ga(b)
          , e = "";
        c.getComputedStyle ? (c = c.getComputedStyle(a, null),
        e = c[d] || c.getPropertyValue(b) || a.style[d]) : a.currentStyle && (e = a.currentStyle[d] || a.style[d]);
        return e
    }
    function G(a) {
        a = a || document;
    ...
    function ca(a) {
        var a = a || document, b;
        o || Yb || Pa ? (b = G(a).scrollLeft,
        a = G(a).scrollTop) : (b = W(a).scrollX,
        a = W(a).scrollY);
        return {
            x: b,
            y: a
    ...
    function Qa(a, b, c) {
        ...
        function g(e, l) {
            for (var i = e.firstChild, o; i; ) {
                ...
                if (n > 0)
                    ...
                    else if (i.nodeType == 3 && (i = i == k.startContainer ? d(i, k.startOffset, i.nodeValue.length) : i == k.endContainer ? d(i, 0, k.endOffset) : d(i, 0, i.nodeValue.length),
                    b))
                        try {
                            l.appendChild(i)
                        } catch (ja) {}
        ...
        if (l.nodeType == 3)
            return l = d(l, a.startOffset, a.endOffset),
            b && i.appendChild(l),
            e(),
            b ? i : a;
        g(l, i);
    ...
    function sb(a, b) {
        ...
        for (var q = 0, r = g.length; q < r; q++) {
            ...
            if (i.nodeType == 1) {
                ...
                i.nodeType == 3 && (n.moveStart("character", i.nodeValue.length),
    ...
    function tb(a, b) {
        ...
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (g.nodeType == 1) {
                var h = f(g), j;
                h.isControl() && (j = c.createElement("span"),
        ...
        b[c])) {
            for (var c = b[c].split(","), b = !1, d = 0, e = c.length; d < e; d++) {
                ...
                var h = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(g)
                  , g = h[2];
                h[1] ? (g = ga(g),
                a[0].style[g] && (a[0].style[g] = "")) : a.removeAttr(g)
            }
            b && a.remove(!0)
        }
    }
    ...
    function zb(a) {
        a.nodeName && (a = V(a),
        a = Ra(a).selectNodeContents(a.body).collapse(!1));
        return new oa(a)
    }
    function Wa(a) {
        var b = a.moveEl
    ...
    function cb(a) {
        for (var b = document.getElementsByTagName("head")[0] || (P ? document.body : document.documentElement), c = document.createElement("link"), d = Fb(ia(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)
        ...
        if (!(o && d !== "br") && (!Y || !(A < 3 && d !== "p")) && !(Pa && A < 9)) {
            ...
            f(c).keydown(function(f) {
                if (!(f.which != 13 || f.shiftKey || f.ctrlKey || f.altKey)) {
                    b.cmd.selection();
                    var j = a(b.cmd.range);
                    j == "marquee" || j == "select" || (d === "br" && !e[j] ? (f.preventDefault(),
                    b.insertHtml("<br />" + (o && A < 9 ? "" : "\u200b"))) : g[j] || Q(c, "formatblock", "<p>"))
                }
            });
            f(c).keyup(function(e) {
                if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br")
                    if (Y) {
                        ...
                        b.cmd.select())
                    } else if (b.cmd.selection(),
                    e = a(b.cmd.range),
                    !(e == "marquee" || e == "select"))
                        if (g[e] || Q(c, "formatblock", "<p>"),
    ...
    function Kb(a, b) {
        ...
        if (a.length === 0)
            return this;
        c.designMode ? (e = this.cmd.range,
        g = e.createBookmark(!0),
        g.html = d.innerHTML) : g = {
            html: d.innerHTML
        };
        Jb(b, g);
        var h = a.pop();
        T(g.html) === T(h.html) && a.length > 0 && (h = a.pop());
        c.designMode ? (c.html(h.html),
        h.start && (e.moveToBookmark(h),
        this.select())) : f(d).html(T(h.html));
        return this
    }
    function ua(a) {
        function b(a, b) {
    ...
    if (!w.raminxz) {
        ...
        E(D, {
            init: function(a) {
                for (var a = Z(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)
                    a[c] && (this[c] = a[c].constructor === D ? a[c][0] : a[c],
                    b++);
                this.length = b;
                this.doc = V(this[0]);
                this.name = Oa(this[0]);
            ...
            attr: function(a, b) {
                ...
                if (typeof a === "object")
                    ...
                    c;
                if (b === i)
                    return b = c.length < 1 ? null : Ba(c[0], a),
                    b === null ? "" : b;
                c.each(function() {
                    Na(this, a, b)
                });
        ...
        E(M, {
            ...
            commonAncestor: function() {
                ...
                for (var b = a(this.startContainer), c = a(this.endContainer), d = 0, e = b.length, g = c.length, f, j; ++d; )
                    if (f = b[e - d],
                    j = c[g - d],
                    !f || !j || f !== j)
                        break;
            ...
            insertNode: function(a) {
                ...
                b.nodeType == 1 ? (j = b.childNodes[c]) ? (b.insertBefore(a, j),
                b === d && (e += k)) : b.appendChild(a) : b.nodeType == 3 && (c === 0 ? (b.parentNode.insertBefore(a, b),
                b.parentNode === d && (e += k)) : c >= b.nodeValue.length ? b.nextSibling ? b.parentNode.insertBefore(a, b.nextSibling) : b.parentNode.appendChild(a) : (j = c > 0 ? b.splitText(c) : b,
            ...
            get: function(a) {
                ...
                if (a && this.isControl())
                    return b = b.body.createControlRange(),
        ...
        E(oa, {
            ...
            select: function(a) {
                ...
                if (a && d.nodeType == 1 && c.collapsed) {
                    ...
                    if (X && (a = d.childNodes,
                    f(d).isInline() || e > 0 && f(a[e - 1]).isInline() || a[e] && f(a[e]).isInline()))
                ...
                if (H)
                    ...
                    b.removeAllRanges(),
                    b.addRange(j),
                    g !== document && (c = f(j.endContainer).pos(),
                    h.scrollTo(c.x, c.y));
                h.focus();
                return this
            },
                    ...
                    if (!g && a == e.start)
                        ...
                        if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
                            ...
                            if (b.type == 3)
                                ...
                                for (var r = i, l = !1; n; ) {
                                    for (; r; )
                                        r.name === n.name && (Zb(r, n.attr(), n.css()),
                                        l = !0),
                                        r = r.first();
            ...
            split: function(a, b) {
                ...
                if (k)
                    ...
                    k = g.lastChild,
                    a ? (e.insertNode(g),
                    c.setStartAfter(k).setEndBefore(d)) : (j.appendChild(g),
                    c.setStartBefore(d).setEndBefore(h)),
                    e = d.parentNode,
                    e == c.endContainer && (j = f(d).prev(),
                    g = f(d).next(),
                    j && g && j.type == 3 && g.type == 3 ? c.setEnd(j[0], j[0].nodeValue.length) : a || c.setEnd(c.endContainer, c.endOffset - 1)),
                    e.removeChild(d);
                return this
            },
            remove: function(a) {
            ...
            createlink: function(a, b) {
                ...
                g && !e.isControl() && (e.selectNode(g.get()),
                this.select());
                ...
                var g = e.startContainer
                  ...
                  , j = e.endContainer
                  , e = e.endOffset;
                if (g.nodeType == 1 && g === j && h + 1 === e && (e = g.childNodes[h],
            ...
            unlink: function() {
                ...
                if (b.collapsed) {
                    ...
                    c && (b.selectNode(c.get()),
                    this.select());
                    Q(a, "unlink", null);
                    X && f(b.startContainer).name === "img" && (a = f(b.startContainer).parent(),
                    a.name === "a" && a.remove(!0))
                } else
                    Q(a, "unlink", null);
                return this
        ...
        E(S, {
            ...
            pos: function(a, b, c) {
                c = l(c, !0);
                if (a !== null && (a = a < 0 ? 0 : s(a),
                this.div.css("left", a),
                c))
                    this.x = a;
                if (b !== null && (b = b < 0 ? 0 : s(b),
                this.div.css("top", b),
                c))
                    this.y = b;
                return this
        ...
        E(qa, S, {
            init: function(a) {
                function b() {
                    ...
                    X && f(b).click(function(a) {
                        f(a.target).name === "img" && (k.selection(!0),
                        k.range.selectNode(a.target),
                        k.select())
                    });
                    if (o)
                    ...
                    b.body.removeAttribute("disabled")) : b.designMode = "on";
            ...
            html: function(a, b) {
                ...
                if (this.designMode) {
                    c = c.body;
                    if (a === i)
                        return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>" : c.innerHTML,
        ...
        f.tabs = function(a) {
            ...
            b.select = function(a) {
                ...
                m(e, function(c, d) {
                    d.unbind();
                    c === a ? (d.addClass("ke-tabs-li-selected"),
                    f(d.data("tab").panel).show("")) : (d.removeClass("ke-tabs-li-selected").removeClass("ke-tabs-li-on").mouseover(function() {
        ...
        ua.prototype = {
            ...
            create: function() {
                ...
                f.each(b.items, function(a, c) {
                    c == "|" ? i.push('<span class="ke-inline-block ke-separator"></span>') : c == "/" ? i.push('<div class="ke-hr"></div>') : (i.push('<span class="ke-outline" data-name="' + c + '" title="' + b.lang(c) + '" unselectable="on">'),
                    i.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + c + '" unselectable="on"></span></span>'))
                });
                var h = b.toolbar = Cb({
                    src: h,
                    html: i.join(""),
                  ...
                  , m = b.edit = Ab({
                    ...
                    afterCreate: function() {
                        ...
                        if (b._undoStack.length > 0) {
                            ...
                            a.start && (b.html(a.html),
                            m.cmd.range.moveToBookmark(a),
                            b.select())
                        }
                        b.afterCreate();
                ...
                k.last().css("visibility", "hidden")) : (Y && f(w).bind("scroll", function() {
                    b._scrollPos = ca()
                }),
                b.resizeType > 0 ? Wa({
                    moveEl: g,
            ...
            resize: function(a, b, c) {
                ...
                c))
                    this.width = s(a);
                if (b && (b = t(b),
                editHeight = t(b) - this.toolbar.div.height() - this.statusbar.height(),
            ...
            addBookmark: function(a) {
                var a = l(a, !0)
                  ...
                  , c = b.doc.body
                  , d = Fa(c.innerHTML);
                if (a && this._undoStack.length > 0 && Math.abs(d.length - T(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize)
                    return this;
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range,
                a = b.createBookmark(!0),
                a.html = Fa(c.innerHTML),
                b.moveToBookmark(a)) : a = {
                    html: d
                };
            ...
            createMenu: function(a) {
                ...
                a.selectedColor !== i ? (a.cls = "ke-colorpicker-" + this.themeType,
                a.noColor = this.lang("noColor"),
                this.menu = Db(a)) : (a.cls = "ke-menu-" + this.themeType,
                a.centerLineMode = !1,
                this.menu = $a(a));
                return this.menu
            },
        ...
        Gb("core", function(a) {
            ...
            b.clickToolbar("source", function() {
                b.edit.designMode ? (b.toolbar.disableAll(!0),
                b.edit.design(!1),
                b.toolbar.select("source")) : (b.toolbar.disableAll(!1),
                b.edit.design(!0),
            ...
            b.clickToolbar("about", function() {
                var a = '<div style="margin:20px;"><div>raminxz ' + Ha + '</div><div>Copyright &copy; <a href="#" target="_blank">none</a> All rights reserved.</div></div>';
                b.createDialog({
                    name: "about",
                    width: 350,
                    title: b.lang("about"),
            ...
            b.afterCreate(function() {
                function c() {
                    ...
                    var d = i[0].innerHTML;
                    i.remove();
                    d !== "" && (X && (d = d.replace(/(<br>)\1/ig, "$1")),
                    b.pasteType === 2 && (d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig, ""),
                    /schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = nb(d, b.filterMode ? b.htmlTags : a.options.htmlTags) : (d = U(d, b.filterMode ? b.htmlTags : null),
                    d = b.beforeSetHtml(d))),
                    b.pasteType === 1 && (d = d.replace(/&nbsp;/ig, " "),
                    d = d.replace(/\n\s*\n/g, "\n"),
                    d = d.replace(/<br[^>]*>/ig, "\n"),
                    d = d.replace(/<\/p><p[^>]*>/ig, "\n"),
                    d = d.replace(/<[^>]+>/g, ""),
                ...
                a(d.body).bind("paste", function(p) {
                    if (b.pasteType === 0)
                        ...
                        if (o) {
                            ...
                            f.range.selectNodeContents(i[0]),
                            f.select();
                        setTimeout(function() {
                            c();
                            m = !1
